...
1. **Googleアカウント**が使えることを確認する（すでに持っている人が多いはずです）
2. 授業用の**ノートブック**を Colab で開く
3. サンプルのCSVを読み込んで、**グラフが1枚出る**ところまで確認する

!!! note "使うアカウント"
    この授業で新しく必要になるのは **Googleアカウント**だけです。
    Copilot は大学アカウントで使います。
